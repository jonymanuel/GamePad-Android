package com.gamepad.lib.andengine.util.adt.spatial.quadtree;

import java.util.ArrayList;
import java.util.List;

import org.andengine.util.IMatcher;
import com.gamepad.lib.andengine.util.adt.bounds.BoundsSplit;
import com.gamepad.lib.andengine.util.adt.bounds.BoundsSplit.BoundsSplitException;
import com.gamepad.lib.andengine.util.adt.bounds.IIntBounds;
import com.gamepad.lib.andengine.util.adt.bounds.IntBounds;
import org.andengine.util.adt.spatial.ISpatialItem;
import com.gamepad.lib.andengine.util.adt.spatial.bounds.util.IntBoundsUtils;
